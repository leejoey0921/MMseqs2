...
//                            }
                            ...
                            //         threadKmerBuffer[bufferPos].adjacentSeq[10 - i] = seq.numSequence[startPos - i];
                            //     }
                            // }else {
                            ...
                            //     }
                            // }
                            // if (endPos + 10 <= static_cast<unsigned int>(seq.L) - 1) {
                            //     for (size_t i = 0; i < 10; i++) {
                            //         threadKmerBuffer[bufferPos].adjacentSeq[10 + i] = seq.numSequence[endPos + 1 + i];
                            //     }
                            // } else {
                            //     for (size_t i = 0; i < static_cast<unsigned int>(seq.L) - 1 - endPos; i++) {
                            //         threadKmerBuffer[bufferPos].adjacentSeq[10 + i] = seq.numSequence[endPos + 1 + i];
                            //     }
                            // }
                            bufferPos++;
...
//         if (hashSeqPair[elementIdx].kmer == SIZE_T_MAX) {
//             {cout << "" << endl;
//              cout << "Kmer : " << hashSeqPair[elementIdx].kmer << endl;
//              cout << "Break point!" << endl;
//              cout << "elementIdx : " << elementIdx << endl;}
//             break;
//         }
//         prevSetSize++;
//         if(prevSetSize > 1 && sequenceWeights != NULL
...
//     }
//     {cout << "" << endl;
//      cout << "splitKmerCount : " << splitKmerCount << endl;
//      cout << "total writePos : " << writePos << endl;
//      cout << "" << endl;}
